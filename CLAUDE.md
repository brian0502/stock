...
| 3 | 當前投資組合分析＋全部位停損 + Layer 2 狀態 | current_strategy.md v4 | 列出每檔停損點與距現價幅度；報 Layer 2（平時「✅ 無重大事件，依停損」／達門檻則發全清警示） |
...
- **Layer 1 移動停利（平時）**：MSFT $430 / NVDA $194.74 / HPE $48（皆全部位）；固定停損不自動上墊，創新高時手動上移。
